...
# --- 1. Configuration ---
INPUT_FILENAME = 'qml_eagles_2015_enhanced.csv'
...
print("--- Starting QML Prediction for Eagles Play Type ---")
...
# Features and target
features = ['qtr', 'down', 'yrdline100', 'ydstogo', 'ScoreDiff',
            'pass_proportion', 'prev_pass_yards', 'prev_run_yards',
            'consecutive_count', 'defense_team_id']
...
# Convert labels to {-1.0, 1.0} floats for the quantum circuit to avoid autograd error.
...
for step in range(num_steps):
    ...
    # --- FIX ---
    # Correctly unpack the two parameters (weights, bias) returned by the optimizer step.
...
vqc_accuracy = accuracy_score(y_test, (vqc_test_preds + 1) / 2) # Convert {-1,1} to {0,1} for sklearn
...
# --- FIX ---
# Simplified and corrected kernel matrix computation to work for all cases.
...
if PLOTTING_AVAILABLE:
    ...
    print("\nPlot saved to model_performance.png")
else:
